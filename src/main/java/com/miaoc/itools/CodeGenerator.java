...
public class CodeGenerator {
    public static void main(String[] args) {
        ...
        generateByTables(serviceNameStartWithI, packageName, "cc", "genealogy", "person");
    ...
    private static void generateByTables(boolean serviceNameStartWithI, String packageName, String author, String ModuleName, String tableNames) {
        ...
        String dbUrl = "jdbc:mysql://47.98.189.101:3306/genealogy?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false";
